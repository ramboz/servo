...
| `/servo:heartbeat` | Routine-triggered, read-only discovery over project signals → triage inbox → oracle-gated dispatch of each actionable finding into an isolated worktree loop, under one whole-heartbeat cost ceiling (the scheduled front-end) | Spec 011 — **IN PROGRESS** |
