...
class OptionsSectionTests(unittest.TestCase):
    ...
    def test_examples_present(self):
        ...
        self.assertIn("```bash", self.text, "SKILL.md should include at least one fenced bash example block")
...
class AuditExampleTests(unittest.TestCase):
    ...
    def test_audit_example_mentions_install_contents(self):
        ...
        self.assertTrue(
            ...
            "audit example should reference tier + components (the manifest's two load-bearing fields)",
        )
