...
- [x] Compliance + craft review verdicts recorded under `reviews/` (`slice-01-compliance.md`, `slice-01-craft.md`). *(Backfilled 2026-08-21 after PR #31 flagged missing review traces; the compliance + craft passes ran per-slice during implementation.)*
...
| `reviews/slice-01-{compliance,craft,reconciliation}.md` | `added` | Committed review traces — verdicts + findings (backfilled per PR #31). |
