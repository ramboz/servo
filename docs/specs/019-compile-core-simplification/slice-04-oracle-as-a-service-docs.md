...
- [ ] `docs/refinement-todo.md` gains an entry for the documented residual
      "silent permission denial, no detection signal" gap (deferred, not
      silently dropped).

### Close-out (post-DONE)
- [ ] `docs/specs/README.md` regenerated by `workflow.py status-board`.
- [ ] Bugs 001/002/004 records gain a cross-link to this slice as the
...
| `docs/refinement-todo.md` | `updated` | _TBD — silent-denial gap entry._ |
